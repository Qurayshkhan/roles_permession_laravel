...
<div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            ...
            <div id="loginform">
                    ...
                    <br>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="post" action="{{ route('admin.register') }}">
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name"value="{{isset($name) ? $name : old('name') }}" aria-label="Name" aria-describedby="basic-addon1" required autocomplete="name">
